...
def get_semeval13_train():
    text = '/home/arne/Masterarbeit/data/semeval2013/SemEval2013-task2-train_dev' \
           '/original_combined-shuffle'
    meta = '/home/arne/Masterarbeit/data/semeval2013/SemEval2013-task2-train_dev' \
           '/meta'
    tweets = {}
...
def get_semeval13_test():
    text = '/home/arne/Masterarbeit/data/semeval2013/SemEval2013-task2-test' \
           '/original_combined'
    meta = '/home/arne/Masterarbeit/data/semeval2013/SemEval2013-task2-test' \
           '/meta'
    tweets = {}
    for line_1, line_2 in zip(open(text), open(meta)):
        tweet, pos, _, _ = line_1.strip().split('\t')
...
def get_semeval14_test():
    tweets = {}
    for line in open('/home/arne/Masterarbeit/data/semeval2014/'
...
def get_semeval15_test():
    tweets = {}
    for line in open('/home/arne/Masterarbeit/data/semeval2015/'
...
def run(x_train, y_train, x_test, y_test):
    features = FeatureUnion(
        transformer_list=[
            ...
            ('sent', Pipeline([
                ('selector', ItemSelector(key='tweets')),
                ('lex', SENTFeatures('/home/arne/Masterarbeit/data/'
                                     'Sentiment140-Lexicon-v0.1')),
            ])),
            ('nrc', Pipeline([
                ('selector', ItemSelector(key='tweets')),
                ('lex', NRCFeatures('/home/arne/Masterarbeit/data/'
    ...
    t = datetime.now()
    with open('/home/arne/Masterarbeit/logs/%i-%i-%i_%i-%i-%i.log' %
        ...
        # retrain routine
        feed = Feeder('/home/arne/Masterarbeit/data/Sentiment140-corpus/'
                      'corpus_cleaned_pos.csv')
        af_wl = AFinnWordList()
        ...
        for i in range(30):
            print('count nr. %i' % i)
            feed.add_best_n(model, 300, x_train, y_train, False, 'filter')
...
train_loc = '/home/arne/Masterarbeit/git_code/FeedbackFramework/twitterData/' \
            'train_alternative.tsv'
dev_loc = '/home/arne/Masterarbeit/git_code/FeedbackFramework/twitterData/' \
          'dev_alternative.tsv'
test_loc = '/home/arne/Masterarbeit/git_code/FeedbackFramework/twitterData/' \
           'test_alternative.tsv'
